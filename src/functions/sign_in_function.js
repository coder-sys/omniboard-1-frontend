...
const sign_in_function = async(fname,lname,password,email)=>{
    let __api__ = await fetch(`http://25xdhfsbmi.execute-api.us-east-2.amazonaws.com/prod/verify_sign_in_information/${email}/${fname}/${lname}`)
    ...
    let api = await fetch(`http://25xdhfsbmi.execute-api.us-east-2.amazonaws.com/prod/sign_in/${fname}/${lname}/${password}/${email}/`)
